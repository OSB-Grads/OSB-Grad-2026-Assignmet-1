...
public class TransferService {
    ...
    {
        AccountDTO srcAccountDto = repository.findAccountByAccountNumber(sourceAccountNumber);
        AccountDTO destAccountDto = repository.findAccountByAccountNumber(destAccountNumber);

...
public class TransferOrchestrator {
    ...
    public void transfer(Long customerId,Long sourceAccountId, Long destinationAccountId,BigDecimal amount) throws InsufficientFundsException, AccountLockedException, SameAccountTransferException, NegativeAmountException, NegativeAmountException, SameAccountTransferException, SQLException {
                db.startTransaction();
